...
clientRoutes.get('/', roleMiddleware(['admin']), async (req, res) => {
    try {
...
clientRoutes.post('/', roleMiddleware(['admin']), async (req, res) => {
    try {
...
clientRoutes.put('/:id', roleMiddleware(['admin']), async (req, res) => {
    try {
...
clientRoutes.delete('/:id', roleMiddleware(['admin']), async (req, res) => {
    try {
