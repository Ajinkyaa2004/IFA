...
updateRoutes.get('/project/:projectId', async (req, res) => {
    try {
...
updateRoutes.get('/employee/:employeeId', async (req, res) => {
    try {
...
updateRoutes.put('/:id', async (req, res) => {
    try {
...
updateRoutes.delete('/:id', async (req, res) => {
    try {
        const update = await Update.findById(req.params.id);
        if (!update) {
            return res.status(404).json({ error: 'Update not found' });
...
updateRoutes.get('/freelancer', async (req, res) => {
    try {
