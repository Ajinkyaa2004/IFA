...
recommendationRoutes.get('/', authMiddleware, roleMiddleware(['admin']), async (req, res) => {
    try {
...
recommendationRoutes.post('/', authMiddleware, roleMiddleware(['admin']), async (req, res) => {
    try {
...
recommendationRoutes.delete('/:id', authMiddleware, roleMiddleware(['admin']), async (req, res) => {
    try {
