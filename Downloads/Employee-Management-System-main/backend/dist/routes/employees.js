...
employeeRoutes.post('/', roleMiddleware(['admin']), async (req, res) => {
    try {
...
employeeRoutes.put('/:id', roleMiddleware(['admin']), async (req, res) => {
    try {
...
employeeRoutes.delete('/:id', roleMiddleware(['admin']), async (req, res) => {
    try {
