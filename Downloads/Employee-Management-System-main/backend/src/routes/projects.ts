...
projectRoutes.post('/', roleMiddleware(['admin']), async (req: AuthRequest, res: Response) => {
  try {
...
projectRoutes.put('/:id', roleMiddleware(['admin']), async (req: AuthRequest, res: Response) => {
  try {
...
projectRoutes.delete('/:id', roleMiddleware(['admin']), async (req: AuthRequest, res: Response) => {
  try {
...
projectRoutes.get('/freelancer/assigned', async (req: AuthRequest, res: Response) => {
  try {
