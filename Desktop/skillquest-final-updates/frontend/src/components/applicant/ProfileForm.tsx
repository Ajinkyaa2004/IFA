                ...
                {whatsappLink && (
                  ...
                  >
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
                          ...
                          {profile.interestedRoles.map((role) => {
                            ...
                            return (
                              <motion.div
                                ...
                                initial={{ scale: 0 }}
                                animate={{ scale: 1 }}
                                className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-game-purple-500/10 to-game-purple-400/10 border border-game-purple-500/30 rounded-full text-sm font-medium text-game-purple-700"
                              >
                                ...
                                <button
                                  ...
                                  className="ml-1 hover:text-game-purple-900 transition-colors"
                                >
                                  ×
                                </button>
                              </motion.div>
